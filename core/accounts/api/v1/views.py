...
class RegistrationApiView(GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            message = EmailMessage('email/activation_email.tpl', 
                                    {'token': token}, 
                                    'admin@admin.com',
                                    to=[user_email],
                                    )
...
class TestEmailSend(GenericAPIView):
    def get(self,request, *args, **kwargs):
       ...
       message = EmailMessage('email/hello.tpl', 
                              {'name': 'Hooman'}, 
                              'admin@admin.com',
                               to=[email],
                               )
...
class ActivationResendApiView(GenericAPIView):
    ...
    def post(self,request, *args, **kwargs):
            ...
            message.send() 
            return Response({'details':'user activation has been resent successfully'},status=status.HTTP_200_OK)
